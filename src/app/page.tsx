		...
		<div className="bg-gray-50 min-h-screen">
			...
			>
				...
				<p className="mt-4 text-xl opacity-80">
					Optimiza los procesos de tu institución educativa de manera fácil y
					eficiente.
				</p>
          ...
          >
			...
			>
				...
				<p className="mt-6 text-lg text-gray-700 opacity-80">
					Fundado en 1975 por el maestro José Antonio Abreu, el Sistema de
					Orquestas es una red de enseñanza musical única en el mundo. Este
					programa no solo forma músicos, sino también ciudadanos responsables y
					comprometidos, proporcionando una plataforma para el desarrollo
					personal y social a través de la música.
				</p>
				<ul className="mt-6 text-left text-lg list-disc list-inside mx-auto max-w-3xl text-gray-700">
					<li>
						Oportunidades para aprender y tocar en orquestas sin costo alguno.
					</li>
					<li>
						Formación integral que abarca valores como la disciplina y el
						trabajo en equipo.
					</li>
					<li>Participación en conciertos nacionales e internacionales.</li>
					<li>
						Programas para fomentar la inclusión social a través de la música.
					</li>
				</ul>
			</section>
			...
			>
				...
				<p className="mt-6 text-lg text-gray-700 opacity-80">
					AbreuSystem es una plataforma diseñada para gestionar de forma
					eficiente los procesos de las instituciones educativas y musicales,
					integrando funcionalidades para la administración académica, logística
					y administrativa en un solo lugar.
				</p>
				<div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-10">
					...
					>
						...
						<p className="mt-4 text-gray-700">
							Organiza y optimiza las cátedras y programas formativos para
							estudiantes.
						</p>
					</div>
					<div
					...
					>
						...
						<p className="mt-4 text-gray-700">
							Simplifica procesos administrativos como generar constancias e
							inscripciones.
						</p>
					</div>
					<div
